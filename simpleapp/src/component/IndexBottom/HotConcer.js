    ...
    return (
      <div className={style.indexlist}>
        ...
        <div className={style.hot}>
          ...
          {/* 演唱会上部 */}
          {singsongstop.length &&
            singsongstop.map((item, index) => {
              return (
                <div key={index} className={style.singtop1}>
        ...
        <div className={style.hot}>
          ...
          {singsongstop.length &&
            singsongstop.map((item, index) => {
              return (
                <div key={index} className={(style.singtop1, style.children)}>
                  <div className={style.sing_l}>
                    <img src={item.img} alt="" />
                  </div>
                  <div className={style.sing_r}>
