...
import css from "../css/city/city.module.css";
  ...
  render() {
    ...
    return (
      <div className={css.box}>
        ...
        {/* 城市列表 */}
        <div className={css.wrapper + " cycityWraper"} ref="wrap">
          <ul className={css.content}>
            {city.map((item, group) => {
              return (
                <li key={group}>
                  <p className={"cy" + item["title"]}>{item["title"]} </p>
                  {item["lists"].map((_item, sub) => {
                    return (
                      <p
                        key={group + sub + "city"}
                        onClick={(e) => {
