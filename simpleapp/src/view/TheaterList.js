      ...
      Theater_Arr: [
        {
          theaterid: 0,
          avatar:
            "https://image.juooo.com//group1/M00/01/D2/rAoKmVwknq2AQjJ3AABZC2s-o9o803.jpg",
          theaterTitle: "南山文体中心",
          time: 53,
          address: "深圳",
    ...
    return (
      <div>
        ...
        <div className={theater_style.header}>
          <span
            className={"iconfont icon-houtui" + " " + theater_style.icontu}
            onClick={() => {
              this.props.history.go(-1);
            }}
          ></span>
          <div className={theater_style.smallbox}>
            <div className={theater_style.toubox}>
              {" "}
              <img src={"/bl/touxiang.jpg"} width="45px" height="45px" />{" "}
            </div>
            <dl>
          ...
          <span className={theater_style.address}>
            {Theater_Arr[0].address} | {Theater_Arr[0].addressDetails}
          </span>
          <NavLink to={"/map"}>
            ...
            return (
              <NavLink to={"/ticket"}>
                <div key={index} className={theater_style.box}>
                  <img
                    src={item.show_posters}
                    className={theater_style.posters}
                  />
                  <div>
                    <ul>
                      <li className={theater_style.intru}>
                        {item.showdatatime}
                      </li>
                      <li className={theater_style.intru}>
                        {item.theaterintroduce}
                      </li>
                      <li>
                        {item.type.map((v, i) => (
                      ...
                      <li className={theater_style.price}>
                        ￥{item.showPricelist}{" "}
                        <span className={theater_style.qi}>起</span>
                      </li>
                    </ul>
                  </div>
                </div>
